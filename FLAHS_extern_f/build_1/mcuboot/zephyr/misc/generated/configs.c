...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_ALERT_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_LOG_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_EXTERNAL_FLASH_SIZE_BITS, 134217728);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MGMT_FMFU_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_MODULE_LOG_LEVEL, 4);
